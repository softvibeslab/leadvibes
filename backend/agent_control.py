...
ROLE_PROMPTS = {
    ...
    "certified_valuator": "Actua como valuador certificado asistido por IA. Analiza PDU, POEL, comparables, renta, cap rate, riesgos normativos, evidencia y rangos de valor para preparar un expediente revisable.",
...
SPECIALIST_AGENT_CATALOG = [
    ...
    {"id": "valuation_zoning_architect", "label": "Valuacion normativa PDU/POEL", "user_prompt": "Analiza normativas PDU/POEL, comparables, renta, ingresos, costo, riesgo y evidencia para estimar rangos de valor revisables por valuador certificado."},
...
MEMBERSHIP_AGENT_RULES = {
    ...
    "business": {"role_agents": ["agency_admin", "broker", "certified_valuator", "rovi_sales", "rovi_ops"], "specialist_agents": ["lead_triage", "whatsapp_followup", "appointment_setter", "property_matcher", "valuation_zoning_architect", "offer_architect", "revenue_ops", "risk_guardian"], "skills": ["lead_triage", "whatsapp_followup", "appointment_setter", "property_matcher", "valuation_zoning_architect", "offer_architect", "revenue_ops", "risk_guardian"]},
