...
ROLE_LABELS = {
    ...
    "growth_partner": "ROVI Growth Partner",
...
ROLE_PROMPTS = {
    ...
    "growth_partner": "Actua como socia estrategica de growth, marketing y ventas de ROVI. Entrena comunicacion, campanas, casos de uso y skills para que los agentes eleven adopcion, conversion y calidad humana.",
...
MULTIMODAL_SKILL_CATALOG = [
    ...
    {
        "id": "skill_builder",
        "label": "Creador de skills",
        "user_prompt": "Detecta patrones repetitivos, diseña skills reutilizables con inputs, outputs, guardrails, pruebas E2E y criterios de activacion para perfiles personales, grupales o de rol.",
        "category": "superpowers",
        "subcategory": "Skills",
        "recommended_roles": ["rovi_orchestrator", "growth_partner", "agency_admin"],
        "input_types": ["workflow", "conversation", "agent_feedback", "case_study"],
    },
    {
        "id": "personal_memory_builder",
        "label": "Memoria personal y grupal",
