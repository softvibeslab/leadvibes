---
source_url: "https://www.chatwoot.com/hc/user-guide/articles/1677695546-languages-supported-in-chatwoot"
captured_at: "2026-06-17T09:59:54.289360+00:00"
author: "Chatwoot"
contributor: "Rovi Codex"
nav_title: "Languages supported in Chatwoot"
---

# Languages supported in Chatwoot

Source: https://www.chatwoot.com/hc/user-guide/articles/1677695546-languages-supported-in-chatwoot

Languages supported in Chatwoot | User Guide | Chatwoot
...
Home 📌 Other topics Languages supported in Chatwoot
...
Mentioned below are the languages supported in Chatwoot and the corresponding shortcodes (derived from ISO 639 language codes ).
...
As outlined in the SDK setup guide , you can configure the locale for the live-chat widget either by passing it in the chatwootSettings or by calling the setLocale method. To specify the locale, use the shortcodes provided above. This will ensure that the widget is displayed in the desired language.

// Pass via window.chatwootSettings window.chatwootSettings = { locale: 'pt_BR', // .. rest of the settings } // Using setLocale method window.$chatwoot.setLocale('pt_BR')
