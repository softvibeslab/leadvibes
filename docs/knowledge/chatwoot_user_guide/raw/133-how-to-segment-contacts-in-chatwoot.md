---
source_url: "https://www.chatwoot.com/hc/user-guide/articles/1775764014-how-to"
captured_at: "2026-06-17T10:01:29.179777+00:00"
author: "Chatwoot"
contributor: "Rovi Codex"
nav_title: "How to Segment Contacts in Chatwoot?"
---

# How to Segment Contacts in Chatwoot?

Source: https://www.chatwoot.com/hc/user-guide/articles/1775764014-how-to

How to Segment Contacts in Chatwoot? | User Guide | Chatwoot
...
Home ⚙️ How To How to Segment Contacts in Chatwoot?
...
Before you begin, you must have labels created in your account. If you haven't created any labels yet, please refer to our guide: How to Add Labels .
...
-
Create Labels (The category name)

-
Bulk Assign Labels (Applying the category to contacts)

-
Save as a Segment (Creating a quick-access view)

### Step 1: Create Labels

Ensure you have a label that represents the segment you want to create (e.g., "Premium Users," "Lead," or "Beta Testers"). Please refer to our guide: How to Add Labels .
...
On the Contacts page, click the Filter icon (top right) then set the filter condition to: Label is equal to [Your Label Name] and Click Apply filters to filter the list.

Once the filtered list appears, click the Save button.
Enter a name for your segment (e.g., "High-Value Leads") and click Save .
Congratulations! Your filtered contacts are now saved as a segment. You can access this segment at any time from the sidebar under the "Segments" tab, ensuring your most important contact groups are always just one click away.
