---
source_url: "https://www.chatwoot.com/hc/user-guide/articles/1779871614-connecting-twilio-voice-channel"
captured_at: "2026-06-17T09:56:58.582169+00:00"
author: "Chatwoot"
contributor: "Rovi Codex"
nav_title: "Connecting Twilio voice channel"
---

# Connecting Twilio voice channel

Source: https://www.chatwoot.com/hc/user-guide/articles/1779871614-connecting-twilio-voice-channel

Connecting Twilio voice channel | User Guide | Chatwoot
...
Home 📞 Voice Channels Connecting Twilio voice channel
...
-
In Chatwoot, create (or open) the "Voice Channel" inbox — Settings → Inboxes → Add Inbox → Voice Channel .

-
Enter your Twilio phone number and the Twilio credentials above, enter your "API Key SID" and "API Key Secret", then save.

-
Chatwoot will then show you two URLs:
...
-
Copy those and update it in the Twilio Dashboard: paste the "Twilio Voice URL" onto both your Twilio phone number settings and your TwiML App, and paste the "Twilio Status Callback URL" onto your phone number's status callback field.

## Steps to enable Voice in existing inboxes

-
Got to your inbox's settings page. (Settings > Inboxes > {Inbox Name})

-
Open the inbox's "Voice" settings tab and turn on radio button labeled "Enable Voice Calling".
...
-
Once saved, the inbox is ready to make and receive calls on that number.
