...
### [workflow-legal-ip-brand-launch.md](./workflow-legal-ip-brand-launch.md)

**What:** A step-by-step legal readiness workflow for software brands that need IP ownership, trademark, company formation, privacy, contracts, and legal operations prepared for professional review.

**Agent used:**
| Agent | Role |
|-------|------|
| Legal IP & Brand Formation Architect | Mexico-first legal operations, IP readiness, software ownership, IMPI/INDAUTOR planning, privacy and contract scaffolding |

**Key takeaway:** The agent turns a messy product/legal situation into a structured attorney-ready packet without pretending to replace licensed legal, tax, notarial, or IP counsel.
