...
| ⚖️ [Legal IP & Brand Formation Architect](specialized/legal-ip-brand-formation-architect.md) | Software IP, trademarks, company formation, privacy, legal ops | Mexico-first legal readiness for software brands, SaaS, AI products, and marketplaces |
...
| 🏙️ [Real Estate Valuation & Zoning Architect](specialized/real-estate-valuation-zoning-architect.md) | PDU/POEL, zoning, market comparables, rent yield, appraisal prep | Certified valuers and real estate teams needing defensible pricing and normative analysis |
