...
export const FinalCTASection = () => {
  const trustBadges = [
    { icon: <Lock className="w-5 h-5" />, text: '14 dias gratis' },
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            ¿Listo para cerrar
            <span className="text-surface-arena-light"> mas ventas</span>
            <br />este mes?
          </h2>

          <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            Unete a mas de 500 inmobiliarias que ya transformaron su proceso de ventas
            y estan cerrando mas propiedades con Rovi CRM.
          </p>
        </motion.div>
        ...
        >
          <Link
            to="/demo-request"
            className="group bg-white text-primary px-10 py-5 rounded-full font-bold text-lg hover:bg-accent-dark transition transform hover:scale-105 flex items-center justify-center shadow-2xl"
          >
          ...
          <a
            ...
            className="group bg-secondary text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-secondary-dark transition transform hover:scale-105 flex items-center justify-center shadow-2xl"
          >
        ...
        >
          Configuracion en 5 minutos • Cancela cuando quieras • Soporte en espanol
        </motion.p>
      </div>
    </section>
  );
